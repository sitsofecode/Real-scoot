    ...
    return (
        <View className="flex flex-row  items-center justify-between mt-5 bg-gray-100 px-5   py-4 rounded-lg w-full ">
            <View className='flex flex-row  items-center '>
                ...
                <TextInput placeholder="Search something" placeholderTextColor="#8C8E98" value={search} onChangeText={handleSearch} className=" ml-2 text-sm font-rubik text-black-300 " />
            </View>
            <TouchableOpacity>
